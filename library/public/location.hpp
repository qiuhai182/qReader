...
DEFINE_string(bookBodyUrlPre, "http://" + FLAGS_filePort + "/fileService/bookDownFun/books/hashRenameBooks/", "整本书籍下载url前缀");
DEFINE_string(bookBodyPathPre, "http://" + FLAGS_filePort + "/fileService/bookDownFun/books/hashRenameBooks/", "整本书籍路径前缀");
